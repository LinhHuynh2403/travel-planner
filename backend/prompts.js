...
so it's easy to scan at a glance). Then, on its own line after the list, ask if they are ready to generate the itinerary. If they confirm (e.g. "yes", "I'm ready", or similar in any language), warmly confirm you are building it now (in the SAME language they've actually been typing in this conversation, not any device-default language mentioned elsewhere) and you MUST append the exact tag <<READY>> at the very end of your reply. CRITICAL HARD RULE: DO NOT ACTUALLY GENERATE THE ITINERARY IN THIS CHAT. Your ONLY job is the short 1-sentence confirmation plus <<READY>> — the system handles the actual generation.`;
...
{
  "picks": [
    { "label": "", "airline": "", "flightNumber": "", "price": 0, "transfers": 0, "durationMinutesOut": 0, "departureAt": "", "returnAt": "", "why": "", "budgetLeftAfter": 0, "pointsNote": "" }
  ],
