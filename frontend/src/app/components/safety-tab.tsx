...
export function SafetyTab({ itinerary }: SafetyTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-jz-card border-[1.5px] border-jz-line rounded-jz-card p-5 space-y-3 shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {commonScams.map((scam, i) => (
            <div key={i} className="bg-jz-card border-[1.5px] border-jz-line rounded-jz-card p-4.5 flex gap-3 items-start shadow-sm">
