    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {phrases.map((p, i) => (
            <div key={i} className="bg-jz-card border-[1.5px] border-jz-line rounded-jz-card p-4 flex flex-col justify-center gap-1 shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {customs.map((c, i) => (
            <div key={i} className="bg-jz-card border-[1.5px] border-jz-line rounded-jz-card p-5 space-y-1.5 shadow-sm">
